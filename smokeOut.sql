...
insert into usuario(persona_idpersona, pass, rol) values("sajo","123", "user");
insert into habitos_iniciales(hora_primer_cig, cig_diarios, persona_idpersona) values("23:04",20,"sajo");

insert into persona values("admin1", "Héctor", "Rodríguez", "2005-08-17", 1);
insert into usuario(persona_idpersona, pass, rol) values("admin1","123", "admin");
